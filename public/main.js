...
if ((firebase.auth().isSignInWithEmailLink(window.location.href)) {
    ...
    var oldHours,
        oldDate,
        oldProject; enterhoursbtn.onclick = function() {
        hoursEntry.value = '';
        dateEntry.value = '';
        projectEntry.value = '';
        keyBox.value = '';
    ...
    var addproject = document.getElementById('addproject'); addprojectbtn.onclick = function() {
    ...
    var hoursEntry = document.getElementById("hoursentry"); submit.onclick = function() {
